...
parser.add_argument('size', type=int, help="sample size 10-90")
...
INPUT_TREE_PATH = files(f"Consensus.sample100.{args.signal}_n{args.size}").joinpath(f"{args.signal}sample{args.number}_n{args.size}.tre")

...
#print(stdg.BipartitionCounts)
print(len(stdg.BipartitionList))
print(stdg.current_tree_included )
print(stdg.BipartitionList[stdg.current_tree_included ==1 ])
print(stdg.DIST)
#print(np.argsort(stdg.BipartitionCounts))
